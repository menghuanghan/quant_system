...
用法：
    ...
    # 处理指定表
    python scripts/run_dwd_full.py --tables price fundamental
...
def main():
    parser = argparse.ArgumentParser(
        description='DWD全量数据处理 - 一键生成三张核心宽表',
    ...
    if 'all' in args.tables:
        tables_to_process = ['price', 'fundamental', 'status']
    else:
